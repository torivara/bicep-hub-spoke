...
@description('Optional. The resource id of private dns zone if applicable.')
...
resource managedCluster 'Microsoft.ContainerService/managedClusters@2021-07-01' = {
  ...
  properties: {
    ...
    networkProfile: {
      networkPlugin: any((empty(aksClusterNetworkPlugin) ? null : aksClusterNetworkPlugin))
      networkPolicy: any((empty(aksClusterNetworkPolicy) ? null : aksClusterNetworkPolicy))
    ...
    apiServerAccessProfile: {
      ...
      privateDNSZone: (aksClusterEnablePrivateCluster == true && privateDnsZoneId != '') ? privateDnsZoneId : null
    }
  }
}
